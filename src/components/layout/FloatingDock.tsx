...
/**
 * Glassmorphic floating dock shown on mobile (< md).
 * 5 primary icons, centered at the bottom.
 */
export default function FloatingDock() {
  const pathname = usePathname();
  const { role } = useAuth();

  // Collect up to 4 primary items plus the profile link as the last dock entry.
